...
ALTER TABLE `account` RENAME COLUMN `provider_accountId` TO `providerAccountId`;--> statement-breakpoint
/*
You're trying to delete PRIMARY KEY(provider,provider_accountId) from 'account' table
