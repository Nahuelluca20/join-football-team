ALTER TABLE `players_to_teams` RENAME COLUMN `group_id` TO `team_id`;--> statement-breakpoint
/*
...
/*
You're trying to delete PRIMARY KEY(group_id,user_id) from 'players_to_teams' table
...
--> statement-breakpoint
/*
You're trying to add PRIMARY KEY(team_id,user_id) to 'players_to_teams' table
